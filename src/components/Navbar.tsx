...
export default function Navbar() {
  ...
  return (
    <nav
      className="fixed top-0 left-0 w-full z-50 flex items-center bg-black transition-colors px-8 md:px-32 py-4"
    >
      <Link href="/" className="font-extrabold text-2xl tracking-wide text-white flex items-center" style={{minWidth:'220px'}} onClick={handleLogoClick}>
        Project Graveyard
      </Link>
